...
import decorator.ScontoVipDecorator;
...
public class App {
    public static void main(String[] args) {
        ...
        // gestore1 ha il decorator attivo, gli altri no
        GestoreOrdine gestore1 = new GestoreOrdine(ordine1, true);
        GestoreOrdine gestore2 = new GestoreOrdine(ordine2, false);
        GestoreOrdine gestore3 = new GestoreOrdine(ordine3, false);
        ...
        // --- STATO: NORMALE ---
        // il centro notifica tutti i gestori tutti gli ordini usano EvasioneNormale
        // (+5%)
        System.out.println("\n===== Stato: NORMALE =====");
        ...
        // --- STATO: PRIORITA ---
        // il centro notifica tutti i gestori tutti gli ordini usano EvasionePrioritaria
        // (+15%)
        System.out.println("\n===== Stato: PRIORITA =====");
        ...
        // --- STATO: CONTROLLO ---
        // il centro notifica tutti i gestori tutti gli ordini usano EvasioneControllata
        // (-5%)
        System.out.println("\n===== Stato: CONTROLLO =====");
        ...
        // --- DECORATOR INCATENATO su ordine2 ---
        // ordine2 riceve sia lo sconto VIP che la notifica
        System.out.println("\n===== ScontoVip + Notifica su ordine2 =====");
        centro.cambiaStato("NORMALE");
        ordine2.setStrategia(new NotificaDecorator(new ScontoVipDecorator(ordine2.getStrategia())));
        System.out.println(ordine2);
        ordine2.eseguiEvasione();
    }
